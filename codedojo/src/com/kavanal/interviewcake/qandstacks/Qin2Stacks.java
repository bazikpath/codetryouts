...
public class Qin2Stacks {
    ...
    public static class QueueTwoStacks {
        ...
        public int dequeue() {
            if (outStack.isEmpty()) {
                ...
                //move items into the outstack
                while (!inStack.isEmpty()) {
                    int currentItem = inStack.pop();
                    outStack.push(currentItem);
                }
    ...
    public static void main(String[] args) {
        Result result = JUnitCore.runClasses(Qin2Stacks.class);
